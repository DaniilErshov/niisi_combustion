...
void IO::Reaction::setTROE_center(const vector<double>& TROE_center)
{
    TROE_center_ = TROE_center;
    flagTROE_center_ = true;
}
...
const vector<double>& IO::Reaction::getTROE_center() const
{
    return TROE_center_;
}
...
const bool& IO::Reaction::hasTROE_center() const
{
    return flagTROE_center_;
}
